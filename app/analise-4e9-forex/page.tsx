// frontend/app/analise-4e9-forex/page.tsx (VERSÃO FINAL CORRIGIDA)
...
export default function Analise4e9ForexPage() {
  ...
  // 2. Inicia os estados de data como strings vazias para evitar hydration error
  ...
  const handleAnalyse = async () => {
    ...
    try {
      ...
      // ### 4. LÓGICA CORRETA DE NOTIFICAÇÃO ###
  ...
  return (
    <main className="bg-background min-h-screen flex flex-col items-center justify-center p-4">
      <Card className="w-full max-w-2xl">
        <CardHeader>
          <CardTitle className="text-2xl">Análise 4 e 9 (Forex - Alpha Vantage)</CardTitle>
          <CardDescription>
            Inicia o backtest da estratégia de gatilhos para pares de moedas.
            <span className="font-semibold text-destructive block mt-2">Nota: Esta funcionalidade requer uma API premium da Alpha Vantage para dados intraday.</span>
          </CardDescription>
        </CardHeader>
